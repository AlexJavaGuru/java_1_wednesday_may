...
import main.java.lv.javaguru.student_vladislav_kulikov.Lesson_10.Task_From_6_to_37.*;
import main.java.lv.javaguru.student_vladislav_kulikov.Lesson_10.Task_From_6_to_37.SearchCriteria.AndSearchCriteria;
import main.java.lv.javaguru.student_vladislav_kulikov.Lesson_10.Task_From_6_to_37.SearchCriteria.AuthorSearchCriteria;
import main.java.lv.javaguru.student_vladislav_kulikov.Lesson_10.Task_From_6_to_37.SearchCriteria.SearchCriteria;
...
class BookDataBaseTest {
    ...
    static void testFindUniqueAuthors() {
        ...
        check(result.contains(book.getAuthor()) && result.contains(book2.getAuthor()), "Test Find Unique Authors");
    }
    ...
    static void testFindUniqueTitles() {
        ...
        check(result.contains(book.getTitle()) && result.contains(book2.getTitle()), "Test Find Unique Titles");
    }
