...
class MAthOperationDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("==============================");
        //(10 - 5) * (20 / 5).
        MathOperation minus = new Subtraction(new Argument(10), new Argument(5));
        MathOperation divide1 = new Divide(new Argument(20), new Argument(5));
        MathOperation multiply1= new Multiply(minus,divide1);
        System.out.println("Test = " + multiply1.calculate());
    }
