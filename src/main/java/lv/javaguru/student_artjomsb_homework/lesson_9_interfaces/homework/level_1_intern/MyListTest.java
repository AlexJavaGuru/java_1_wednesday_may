...
class MyListTest {
    ...
    public void sortMinMax() {
        ...
        ArrayList<Integer> testArray = new ArrayList<>(Arrays.asList(5, -10, 3, -5, 1));
        ArrayList<Integer> expectedResult = new ArrayList<>(Arrays.asList(-10, -5, 1, 3, 5));
    ...
    public void sortMaxMin() {
        MyList arrayUtil = new MyListImpl();
        ArrayList<Integer> testArray = new ArrayList<>(Arrays.asList(5, -10, 3, -5, 1));
        ArrayList<Integer> expectedResult = new ArrayList<>(Arrays.asList(5, 3, 1, -5, -10));
    ...
    public void deleteNumberByID() {
        MyList arrayUtil = new MyListImpl();
        ArrayList<Integer> testArray = new ArrayList<>(Arrays.asList(5, -10, 3, -5, 1));
        ArrayList<Integer> expectedResult = new ArrayList<>(Arrays.asList(5, -10, 3, 1));
    ...
    public void deleteNumber() {
        MyList arrayUtil = new MyListImpl();
        ArrayList<Integer> testArray = new ArrayList<>(Arrays.asList(5, -10, 3, -5, 1));
        ArrayList<Integer> expectedResult = new ArrayList<>(Arrays.asList(5, 3, -5, 1));
    ...
    public void findMostFrequentNumber() {
        MyList arrayUtil = new MyListImpl();
        ArrayList<Integer> testArray = new ArrayList<>(Arrays.asList(5, 33, -10, 33, -5, 1, -10, 33));
    ...
    public void addNumber() {
        MyList arrayUtil = new MyListImpl();
        ArrayList<Integer> testArray = new ArrayList<>(Arrays.asList(5, -10, 3, -5, 1));
        ArrayList<Integer> expectedResult = new ArrayList<>(Arrays.asList(5, -10, 3, -5, 1, 34));
