package lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.test;

import static lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.test.InsuranceObjectBuilder.createInsuranceObject;
import static lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.test.PolicyBuilder.createPolicy;
import static lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.test.SubInsuranceObjectBuilder.createSubInsuranceObject;

import java.math.BigDecimal;

import lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.businesslogic.InsuranceObjectPremiumCalculator;
import lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.businesslogic.InsurancePolicyPremiumCalculator;
import lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.businesslogic.InsuranceRiskCoefficientDetector;
import lv.javaguru.teacher.lesson_x.insurance_policy.solutions.v4.domain.InsuranceRisk;
