package main.java.lv.javaguru.student_miroslavs_fjodorovs.lesson_6.level_2;
...
class DayOfTheWeekDetectorTest {
    ...
    public static void main(String[] args) {
        ...
        test.shouldReturnIncorrectDayNumber();
    }
    ...
    public void shouldReturnIncorrectDayNumber() {
        DayOfTheWeekDetector detector = new DayOfTheWeekDetector();
        String dayOfTheWeek = detector.findDayOfTheWeek(71);
        checkTestResult("Incorrect day number".equals(dayOfTheWeek), "Incorrect day number");
    }
